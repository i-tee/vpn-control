...
class Handler extends WebhookHandler
{
    ...
    public function homeVpn(): void
    {
        $text = "🏠 *VPN для всего дома или квартиры*\n\n"
            . "Мы можем приехать лично и настроить VPN прямо на вашем (или нашем) роутере — тогда *все устройства дома* будут защищены автоматически: телевизор, телефоны, ноутбуки, планшеты.\n\n"
